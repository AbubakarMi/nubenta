  ...
  return (
    ...
    >
      <div className="container mx-auto flex h-20 items-center justify-between px-4 md:px-6">
        <Link href="/technology" className="flex items-center gap-2 font-bold text-xl text-primary">
          ...
          <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
            ...
            <SheetContent side="right" className="w-[280px] bg-background">
              <div className="flex flex-col h-full p-6">
                <Link href="/technology" className="flex items-center gap-2 font-bold text-xl text-primary mb-8" onClick={closeMobileMenu}>
                  <Cpu className="h-6 w-6 text-accent" />
                  <span>Nubenta Technology</span>
                </Link>
